...
class ExtTmuxRenderer(Renderer):
	'''Powerline ext-tmux segment renderer.'''
	...
	def render(self, width=None, segment_info={}, **kwargs):
		if width and segment_info:
			...
			if width < 10:
				width = 10
		return super(ExtTmuxRenderer, self).render(width=width, segment_info=segment_info, **kwargs)
